...
def create_training_options():
    ...
    parser.add_argument("--name",           type=str,   default="experient1",        help="experiment ID")
    parser.add_argument("--ckpt",           type=str,   default=None,        help="resumed checkpoint name")
    parser.add_argument("--gpu",            type=int,   default=None,        help="set only if you wish to run on a particular device")
    parser.add_argument("--n-gpu-per-node", type=int,   default=1,           help="number of gpu on a each node")
    ...
    parser.add_argument("--dataset-format", type=str, default="lmdb", choices=["lmdb", "imagefolder"], help="dataset backend")
